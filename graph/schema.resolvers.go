...
func (r *mutationResolver) CreateJobListing(ctx context.Context, input model.CreateJobListingRequest) (*model.JobListing, error) {
	return r.Services.JobLisingService.CreateJobListing(input)
}

// UpdateJobListing is the resolver for the updateJobListing field.
func (r *mutationResolver) UpdateJobListing(ctx context.Context, id string, input model.UpdateJobListingRequest) (*model.JobListing, error) {
...
func (r *queryResolver) Jobs(ctx context.Context) ([]*model.JobListing, error) {
	jobs, err := r.Services.JobLisingService.ListAllJobs()
	if err != nil {
		return nil, err
	}
	return jobs, nil
...
func (r *queryResolver) Job(ctx context.Context, id string) (*model.JobListing, error) {
	return r.Services.JobLisingService.GetJobById(id)
}
